...
export default function Inventario() {
  ...
  const barColor = (dias) => dias <= 3 ? '#E24B4A' : dias <= 7 ? '#EF9F27' : '#3B6D11'
                    ...
                    <tr key={inv.id || inv.nombre}>
                      <td>
                        ...
                        <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden mt-1 w-24">
                          <div className="h-full rounded-full transition-all" style={{ width: `${pct}%`, background: dias != null ? barColor(dias) : '#BA7517' }} />
                        </div>
                      </td>
