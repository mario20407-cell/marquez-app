...
function FormReceta({ inicial, onGuardar, onCancelar, productos }) {
  ...
  const handleGuardar = () => {
    ...
    onGuardar({
      producto: prod.nombre, categoria: prod.categoria, pventa: prod.precio, presentacion: prod.presentacion,
...
export default function Recetas() {
  ...
  const importarPegado = async () => {
    ...
    await guardar({ producto: prod.nombre, categoria: prod.categoria, pventa: prod.precio, presentacion: prod.presentacion,
